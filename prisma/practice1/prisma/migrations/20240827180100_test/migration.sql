...
CREATE TABLE "Post" (
    "id" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "everageRating" DOUBLE PRECISION NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favotitedById_fkey" FOREIGN KEY ("favotitedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
